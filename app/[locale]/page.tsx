...
import { defaultLocale, getAlternateLanguageMap, getDictionary, getLocaleMeta, isLocale, localeMeta, locales, type Locale } from '@/lib/i18n';
...
const btnBase = 'inline-flex items-center justify-center rounded-xl font-extrabold transition-all duration-200 cursor-pointer border border-transparent';
const btnSolid = 'text-white bg-gradient-to-br from-brand-light to-brand-deep shadow-brand-glow hover:-translate-y-0.5 hover:shadow-brand-glow-strong';
                ...
                <div className={containerClass}>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0 md:min-h-[560px] md:[perspective:1400px] py-4">
                        {screenshots.map((url, index) => {
                            const positionClass =
                                index === 0
                                    ? 'md:[transform:perspective(1400px)_rotateY(28deg)_translateX(80px)_scale(0.88)] md:brightness-75 md:z-[1] md:hover:brightness-95'
                                    : index === 1
                                      ? 'md:-translate-y-3 md:scale-[1.06] md:z-[3] md:shadow-phone-center md:hover:-translate-y-[18px] md:hover:scale-[1.08]'
                                      : 'md:[transform:perspective(1400px)_rotateY(-28deg)_translateX(-80px)_scale(0.88)] md:brightness-75 md:z-[1] md:hover:brightness-95';
